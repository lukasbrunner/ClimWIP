...
"""
Time-stamp: <2020-09-10 19:25:51 lukas>
...
SAVENAME = 'figure1a.png'
FILENAME_PATTERN = 'tas_global_perfect_free_sigma_{ssp}_{trend}_41-60.nc'
...
def main():
    ...
    fig, ax = plt.subplots()
    fig.subplots_adjust(left=.08, right=.99, bottom=.18, top=.95)
    ...
    leg = ax.legend([h1, h4], ['SSP126', 'SSP585'], loc='lower center', title='Median, 50\%, 90\%')
    leg._legend_box.align = 'left'
    ax.set_title('\\textbf{(a) Performance weighting perfect model test skill 2041-2060}',
