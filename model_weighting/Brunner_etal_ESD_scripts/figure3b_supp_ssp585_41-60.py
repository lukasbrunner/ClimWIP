...
"""
Time-stamp: <2020-09-12 13:48:23 lukas>
...
FILENAME = 'tas_global_pseudo_obs_ssp585_050_*-CMIP5-RCP85_41-60_ind.nc'
...
def plot_maps_mean(da, title=None, cmap='PuOr'):
    ...
    ax.set_title('\\textbf{(b) Combined weighting perfect model test median skill: SSP5-8.5, 2041-60 (\%)',
                 loc='left', fontdict={'size': 'large', 'weight': 'bold'})

    plt.savefig(os.path.join(SAVEPATH, 'figure3b_supp_ssp585_41-60.png'), dpi=300)
    plt.savefig(os.path.join(SAVEPATH2, 'figure3b_supp_ssp585_41-60.pdf'), dpi=300)

    plt.savefig(os.path.join(SAVEPATH, 'figure3b.png'), dpi=300)
    plt.savefig(os.path.join(SAVEPATH2, 'figure3b.pdf'), dpi=300)
...
def main():
    ...
    plot_maps_mean(
        skill.median('perfect_model_ensemble'), cmap='PuOr_r')
