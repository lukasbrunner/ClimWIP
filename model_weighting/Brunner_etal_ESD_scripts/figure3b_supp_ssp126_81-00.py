...
"""
Time-stamp: <2020-09-12 18:00:41 lukas>
...
FILENAME = 'tas_global_pseudo_obs_ssp126_050_*-CMIP5-RCP26_81-00_ind.nc'
...
def plot_maps_mean(da, title=None, cmap='PuOr'):
    ...
    ax.set_title('\\textbf{(c) Combined weighting perfect model test median skill: SSP1-2.6, 2081-2100 (\%)}', loc='left',
                 fontdict={'size': 'large', 'weight': 'bold'})

    plt.savefig(os.path.join(SAVEPATH, 'figure3b_supp_ssp126_81-00.png'), dpi=300)
    plt.savefig(os.path.join(SAVEPATH2, 'figure3b_supp_ssp126_81-00.pdf'), dpi=300)
