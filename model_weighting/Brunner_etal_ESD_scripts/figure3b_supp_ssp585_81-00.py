...
"""
Time-stamp: <2020-09-12 18:00:58 lukas>
...
FILENAME = 'tas_global_pseudo_obs_ssp585_050_*-CMIP5-RCP85_81-00_ind.nc'
...
def plot_maps_mean(da, title=None, cmap='PuOr'):
    ...
    ax.set_title('\\textbf{(d) Combined weighting perfect model test median skill: SSP5-8.5, 2081-2100 (\%)}', loc='left',
                 fontdict={'size': 'large', 'weight': 'bold'})

    plt.savefig(os.path.join(SAVEPATH, 'figure3b_supp_ssp585_81-00.png'), dpi=300)
    plt.savefig(os.path.join(SAVEPATH2, 'figure3b_supp_ssp585_81-00.pdf'), dpi=300)
